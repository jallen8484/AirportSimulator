...
public class Airport2View extends JFrameView {
	...
	class Handler2 implements ChangeListener {
		...
		public void stateChanged(ChangeEvent e) {
			((Tower2) getController()).setSpeed(jsSpeed.getValue());
		}
	 ...
	 *            the controller
	 */
	public Airport2View(Airport2 model, Tower2 controller) {
