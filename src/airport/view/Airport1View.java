...
public class Airport1View extends JFrameView
{
	...
	public Airport1View(Airport1 model, Tower1 controller)
	{
	...
	class Handler implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			if ( e.getActionCommand() == STARTSIM)
			{
				...
				((Tower1)getController()).SimulatorStart(
						Integer.parseInt(jTextFieldNumberAirplanesToGenerate.getText()),
						Double.parseDouble(jTextFieldAirplaneArrivalRate.getText()));
			}
	...
	class Handler2 implements ChangeListener
	{
		...
		{
			((Tower1)getController()).SimulatorSpeedChange(jSlider1.getValue());
		}
	}
